...
# from img_test import split_letters
import numpy as np
...
# https://xiaoyuan.zhaopin.com/LoginManager/GetValidateCode?r=0.5721792161614632
...
for fname, contents in image_contents.items():
    ...
    if letters is not None:
        ...
        for i, letter in enumerate(letters):
            ...
            data_y.append(np.uint8(ord(content) - 48))  # 65: 'A'
